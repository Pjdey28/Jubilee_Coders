...
function MovieChatbot() {
    ...
    function getDefaultResponse() {
      ...
      - Movies similar to [your favorite movie]
      ...
      async function getResponse(e) {
        ...
        try {
            const res = await fetch("https://movie-bot-1-cb0h.onrender.com/api/ServiceHubAI", {
                method: "POST",
        ...
        <div className="relative z-50">
            ...
            {isOpen && (
                <div
                    ...
                    style={{ height: "80vh", maxHeight: "80vh", width: "24rem" }} // Fixed width
                >
                    <div className="bg-gray-800 p-4 border-b border-gray-700">
                        ...
                        <p className="text-sm text-gray-400 mt-1">Ask me about movies and shows!</p>
                    </div>
            ...
            {!isOpen && (
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white rounded-full p-3 shadow-lg flex items-center justify-center w-12 h-12 transition-all duration-200 hover:scale-105"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
