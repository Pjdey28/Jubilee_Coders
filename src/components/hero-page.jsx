...
const HeroPage = () => {
  return (
   ...
   <h1>Inspiration with Us</h1>
    ...
    <button className='text-xl md:text-2xl bg-blue-500 text-black p-3 md:p-5 rounded-full'><a href="/blogs" className=' flex items-center cursor-pointer gap-2'>Create Your Blog<CircleArrowRight/></a></button>
    </div>
   </section>
  )
}
